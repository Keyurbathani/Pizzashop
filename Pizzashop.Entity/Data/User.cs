...
public partial class User
{
    ...
    public DateTime? TokenExpiary { get; set; }
    ...
    public virtual ICollection<ModifierAndGroup> ModifierAndGroupCreatedByNavigations { get; set; } = new List<ModifierAndGroup>();

    public virtual ICollection<ModifierAndGroup> ModifierAndGroupModifiedByNavigations { get; set; } = new List<ModifierAndGroup>();
